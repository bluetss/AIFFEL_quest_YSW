...
원문은 해당 링크([https://www.facebook.com/notes/mark-zuckerberg/building-jarvis/10154361492931634](https://www.facebook.com/notes/mark-zuckerberg/building-jarvis/10154361492931634))에서 확인하실 수 있습니다.
...
---
## 느낀점
마크다운은 익숙하지 않았는데, 노션을 사용하면서 마크다운 문법을 몇개 알고 있던 게 오늘 공부에서 많은 도움이 되었다.

깃허브도 평소에 자주 사용하던 서비스라서 오늘 내용은 금방 끝낼 줄 알았지만 클라우드 원격 환경에서 깃 초기화부터 push까지 하는 것은 처음이어서 살짝 헤맸다. 특히 push 같은 작업을 할 때마다 token을 생성하고 입력하는 방식은 처음 배워 재미있게 시도해봤다.
